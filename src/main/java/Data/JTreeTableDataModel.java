...
public class JTreeTableDataModel extends AbstractTreeTableModel {

    private List<IDataModelItem> items;

    public JTreeTableDataModel() {super((Object)null);}
    public JTreeTableDataModel(List<IDataModelItem> items) {
        super((Object)null);
        this.items = items;
    }
...
//        }
        ...
        value = ((Record) object).get(fldName);
    ...
    public Object getValueAt(Object node, int column) {
        if (this.items == null) {
            ...
            Object obj = this.getValue(this.items.get(column).Name(), ((ObjectNode)node).getRecord());
            return obj;
        }
    }
    ...
    public List<IDataModelItem> getItems() {
        return new ArrayList<IDataModelItem>(items);
    }
